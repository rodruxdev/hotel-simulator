const INCIDENTS = [
  ...
  "¡Ascensor fuera de servicio! - Paga Bs.1,500 por reparación urgente.",
  "¡Fuga de agua! - Pierdes Bs.500 en materiales y mano de obra.",
  "¡Cortocircuito! - Contrata a un electricista por Bs.2,000.",
  "¡Ventana rota! - Gasta Bs.350 en reemplazo inmediato.",
  "Aire acondicionado averiado en una habitación ocupada. - Reubica a los huéspedes y paga Bs.800.",
  "¡Inundación sorpresa! - Gasta Bs.1,200 en limpieza profunda.",
  "¡Invasión de insectos! - Pierdes Bs.400 en fumigación.",
  "Obstrucción en la tubería. - Pierdes Bs.600 por el trabajo de plomería.",
  "¡Sistema de reservas fuera de línea! - Paga Bs.1,000 por soporte técnico.",
  "¡Cerraduras electrónicas dañadas! - Compra repuestos por Bs.300.",
  "Renuncia inesperada del gerente. - Pierdes Bs.2,500 en indemnización.",
  "Huelga del personal. - Gasta Bs.1,800 en negociar incentivos.",
  "Horas extras imprevistas. - Paga Bs.700 a tu equipo.",
  "¡Epidemia entre empleados! - Contrata reemplazos por Bs.1,000.",
  "Error en la nómina. - Pierdes Bs.500 en reembolsos.",
  "Consultor temporal para marketing digital. - Contrátalo por Bs.2,000.",
  "Huésped insatisfecho. - Ofrece una compensación de Bs.300.",
  "Cancelación mal gestionada. - Pierdes Bs.250.",
  "Vehículo del huésped dañado en el garage. - Paga Bs.1,500 en reparaciones.",
  "Equipaje perdido. - Compensa con Bs.600 al cliente.",
  "Comida en mal estado. - Devuelve Bs.400.",
  "Fiesta ruidosa. - Gasta Bs.200 en mover a los huéspedes.",
  "Error en facturación. - Reembolsa Bs.150.",
  "Objeto olvidado. - Envía por paquetería y paga Bs.50.",
  "Reubicación de habitación. - Pierdes Bs.100 por molestias al huésped.",
  "Multa por higiene deficiente. - Paga Bs.1,000.",
  "Auditoría sorpresa. - Contrata asesoría por Bs.1,500.",
  "Sanción ambiental. - Pierdes Bs.700 por mala gestión de residuos.",
  "¡Protocolos de seguridad vencidos! - Gasta Bs.800 en actualizarlos.",
  "Violación laboral. - Paga una multa de Bs.1,200.",
  "Mejora de accesibilidad. - Pierdes Bs.3,000.",
  "Ataque cibernético. - Paga Bs.2,500 por recuperación de datos.",
  "¡Hackeo de datos! - Paga Bs.4,000 en sanciones.",
  "Equipos tecnológicos dañados. - Pierdes Bs.600 en reparaciones.",
  "Wi-Fi caído. - Contrata a un técnico por Bs.300.",
  "Actualización del software. - Gasta Bs.2,000 en la nueva licencia.",
  "Retraso en entrega de insumos. - Pierdes Bs.200 por compras urgentes.",
  "Incremento en costos de alimentos. - Pierdes Bs.500.",
  "Producto dañado en el transporte. - Pierdes Bs.400.",
  "Desabastecimiento de materiales de limpieza. - Gasta Bs.300 en proveedores alternos.",
  "Costo de almacenamiento extra. - Pierdes Bs.150.",
  "Incendio inesperado. - Gasta Bs.5,000 en evacuación y reparaciones.",
  "Apagón prolongado. - Pierdes Bs.2,000 en combustible para generadores.",
  "Limpieza por epidemia. - Gasta Bs.1,800.",
  "¡Estructura dañada! - Paga Bs.3,000 en reparaciones.",
  "Intoxicación en el restaurante. - Pierdes Bs.1,000 por compensaciones.",
  "Crisis de inseguridad pública. - Pierdes Bs.3,500 en cancelaciones.",
  "Actos vandálicos. - Gasta Bs.1,500 en reparaciones.",
  "Cierre temporal por desastre natural. - Pierdes Bs.4,000.",
  "Cancelaciones masivas en temporada alta. - Pierdes Bs.5,000.",
  "¡Upgrade inesperado! - Ganas Bs.500 extra de un cliente VIP.",
  "Suite reservada de último momento. - Recibes Bs.800 inesperados.",
  "Extensión de estancia por mal clima. - Ganas Bs.1,200 adicionales.",
  "Venta de tours. - Recibes Bs.300 de comisión.",
  "Evento corporativo inesperado. - Obtén Bs.5,000 en ingresos.",
  "Alquiler de coworking. - Ganas Bs.1,000 extra.",
  "Consumo elevado en el restaurante. - Ganas Bs.700 más.",
  "Venta de souvenirs. - Obtienes Bs.400.",
  "Membresías de spa. - Recibes Bs.1,500.",
  "Lavandería premium. - Ganas Bs.250 extra.",
  "Reserva de boda. - Obtén Bs.3,000 adicionales.",
  "Promoción en redes sociales. - Incrementa tus ingresos en Bs.2,000.",
  "Grupo grande en el bar. - Ganas Bs.600 inesperados.",
  "Cancelación en la competencia. - Obtén Bs.1,800 en reservas.",
  "Paquetes promocionales agotados. - Ganas Bs.2,500.",
  "Alquiler para sesión fotográfica. - Obtén Bs.800.",
  "Tarifa elevada de última hora. - Ganas Bs.1,500.",
  "Huéspedes teletrabajando. - Recibes Bs.1,200 adicionales.",
  "Bono anticipado de una aerolínea. - Ganas Bs.2,000.",
  "¡Early check-in y late check-out! - Recibe Bs.400 extra.",
];
